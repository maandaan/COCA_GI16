...
%     pres_obj_count = 2;
% else
%     load('data/Synthesized Scenes/scene_zeinab_012.mat', 'final_scene');
...
% save('data/test_cases/bedroom_sampled_scenes_007.mat', 'sampled_scenes');
 
% % room = select_room(models_dir); %randomly select a layout
% load('data/test_cases/bedroom_sampled_scenes_007.mat');
...
% save('data/test_cases/bedroom_sample_scene_010.mat', 'scene');
 
load('data/test_cases/bedroom_sample_scene_010.mat', 'scene');
%optimize the placement
[ final_scene ] = optimize_arrangement_scene( scene );
save('data/Synthesized Scenes/scene_zeinab_013.mat', 'final_scene');
...
out_file = [scenes_dir 'synth_scene_41_progressive_synthesis.txt'];
