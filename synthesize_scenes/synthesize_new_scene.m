...
%     pres_obj_count = 2;
% else
%     load('data/Synthesized Scenes/scene_zeinab_013.mat', 'final_scene');
...
% save('data/test_cases/bedroom_sampled_scenes_008.mat', 'sampled_scenes');
 
% room = select_room(models_dir); %randomly select a layout
% load('data/test_cases/bedroom_sampled_scenes_008.mat');
% scene = sampled_scenes(7).scene;
...
% save('data/test_cases/bedroom_sample_scene_011.mat', 'scene');
%  
...
% save('data/Synthesized Scenes/scene_zeinab_015.mat', 'final_scene');
